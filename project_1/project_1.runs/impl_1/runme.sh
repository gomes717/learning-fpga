...
HD_PWD='C:/Users/guigu/OneDrive/Documentos/projetos/fpga/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log study_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source study_1.tcl -notrace
