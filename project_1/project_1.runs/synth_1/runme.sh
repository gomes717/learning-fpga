...
HD_PWD='C:/Users/guigu/OneDrive/Documentos/projetos/fpga/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log study_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source study_1.tcl
